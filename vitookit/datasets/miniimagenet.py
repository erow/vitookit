...
## copy from https://github.com/yaoyao-liu/mini-imagenet-tools
##+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
class MiniImageNetDataLoader(object):
    def __init__(self, shot_num, way_num, episode_test_sample_num, shuffle_images = False,root="."):
        ...
        metatrain_folder = os.path.join(root, 'train')
        metaval_folder = os.path.join(root, 'val')
        metatest_folder = os.path.join(root, 'test')
