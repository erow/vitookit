...
This is a implementation of the DEMS model in https://github.com/visresearch/dems/tree/main

## Usage
```
vitrun eval_cls.py  --data_set CIFAR10 --data_location ../data --input_size 32  --ckpt_freq 10  --warmup_epochs=10 --epochs 800 --batch_size=256  --model dems_tiny_patch2_32  --weight_decay 0.05  --gin "build_transform.scale=(0.7,1)" build_transform.mean="(0.4914, 0.4822, 0.4465)" build_transform.std="(0.2470, 0.2435, 0.2616)"
```
"""
