...
class SimLAPFuse(nn.Module):
    def __init__(self,
                 ...
                 iter_num=1,
                 num_classes=1000):
        super(SimLAPFuse, self).__init__()
    ...
    def criterion(self, samples, targets, **kwargs):
        ...
        self.log['simlap_loss'] = simlap_loss.item()
