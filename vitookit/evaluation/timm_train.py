...
from vitookit.utils.helper import wandb_download
...
def main():
    ...
    if args.pretrained_path:
        ...
        if args.pretrained_path.startswith("wandb:"):
            args.pretrained_path = wandb_download(args.pretrained_path)
    ...
    if utils.is_primary(args) and args.log_wandb:
        if has_wandb:
            wandb.init(project=args.experiment, config=args, job_type="finetune")
        else:
            _logger.warning(
